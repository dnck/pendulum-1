...
public class API {
     ...
     * @return {@link net.helix.pendulum.service.dto.WereAddressesSpentFrom}
     **/
     ...
     * @return {@link net.helix.pendulum.service.dto.AddedNeighborsResponse}
     **/
     ...
     * <b>udp://IPADDRESS:PORT</b>
     *
     * Returns an {@link net.helix.pendulum.service.dto.ErrorResponse} if the URI scheme is wrong
     *
     * @param uris The URIs of the neighbors we want to remove.
     * @return {@link net.helix.pendulum.service.dto.RemoveNeighborsResponse}
     **/
     ...
     * @return {@link net.helix.pendulum.service.dto.GetTransactionsToApproveResponse}
     ...
     *
     * @return {@link net.helix.pendulum.service.dto.GetTipsResponse}
     **/
     ...
     *
     * @return {@link net.helix.pendulum.service.dto.GetNodeInfoResponse}
     **/
    private AbstractResponse getNodeInfoStatement() throws Exception {
        String name = configuration.isTestnet() ? Main.TESTNET_NAME : Main.MAINNET_NAME;
        RoundViewModel round = RoundViewModel.first(tangle);
        return GetNodeInfoResponse.create(name, Main.VERSION,
     ...
     *     Boolean values will be <tt>true</tt> for confirmed transactions, otherwise <tt>false</tt>.
     * </p>
     * Returns an {@link net.helix.pendulum.service.dto.ErrorResponse} if a tip is missing or the subtangle is not solid
     *
     ...
     * Returns an {@link net.helix.pendulum.service.dto.ErrorResponse} if more than maxFindTxs was found.
     *
     * @param request The map with input fields
     *                Must contain at least one of 'bundles', 'addresses', 'tags' or 'approvees'.
     * @return {@link net.helix.pendulum.service.dto.FindTransactionsResponse}.
