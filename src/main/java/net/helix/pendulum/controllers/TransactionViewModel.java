...
public class TransactionViewModel {
    ...
    public static final int ESSENCE_OFFSET = ADDRESS_OFFSET;
    public static final int ESSENCE_SIZE = ADDRESS_SIZE + VALUE_SIZE + BUNDLE_NONCE_SIZE + TIMESTAMP_SIZE + CURRENT_INDEX_SIZE + LAST_INDEX_SIZE;
