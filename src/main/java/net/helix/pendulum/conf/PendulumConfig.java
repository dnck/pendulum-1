 ...
 */
public interface PendulumConfig extends APIConfig, NodeConfig, DbConfig, ConsensusConfig, ZMQConfig, TipSelConfig, PoWConfig, SolidificationConfig, LoggingConfig {
